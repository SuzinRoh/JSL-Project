...
<!--  로그인 폼 추가 -->
     ...
     <table border="0" width="90%" align="center">
       <tr>
         <td colspan="2"><img src="/img/bullet-01.gif"> 
           <font color="blue" size="3">참 좋은 자료실 ${page}</font><font size="2"> - 자료읽기</font></td>
       </tr>
     </table>
     <p>
 ...
 <c:if test="${!empty pds.filename}">   
    <img src="/img/disk.gif" align="middle" width="22" height="20" border="0">&nbsp;
    	<a href="/resources/upload/${pds.filename}">${pds.filename}</a>
 </c:if>	
	</font></td></tr>
  </table>
  <p align="center">
  <font size="2">
  <a href="pds_modify?idx=${pds.idx}&page=${page}"><img src="/img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:pds_del()"><img src="/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
