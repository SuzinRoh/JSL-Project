...
public class PdsController {
	...
	public void pdsListSearch(@RequestParam("page") int page, PageVO pg,Model model) {
		...
		pg2.setStartpage(startpage);
		pg2.setEndpage(endpage);
		
		List list = service.pdsList(pg2);
		...
		model.addAttribute("listPage",PageIndex.pageList(nowpage,totpage,url,""));
		model.addAttribute("listPage",PageIndex.pageListHan(nowpage,totpage,url,pg.getSearch(),pg.getSearch()));
