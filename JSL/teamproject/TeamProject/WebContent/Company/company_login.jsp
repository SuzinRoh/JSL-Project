...
<script>
	...
	function idfound() {
		window.open('Company?cmd=company_idfound', 'IdFound',
				'top=100px, left=100px, height=500px, width=500px');
	}
	function passfound() {
		window.open('Company?cmd=company_passfound', 'PasswordFound',
				'top=100px, left=100px, height=500px, width=500px');
	}
</script>
<head>
...
<body>
	...
	<!--       <h1 class="logo"><a href="index.jsp">Rapid</a></h1> -->
		...
		<section class="inner-page pt-4">
			<div class="container_com">
				<form name="company" method="post">
					...
					<div class="idinput">
						<input type=text name="com_id" placeholder="아이디">
					</div>
					<div class="passinput">
						<input type=password name="com_pass" placeholder="비밀번호">
					</div>
					<div class="btn_div">
						<button value="로그인" class=btn_login name=btn
							onClick="javascript:send()">로그인</button>
					</div>
					<div class="search_div">
						<a href="javascript:idfound()">아이디찾기</a> 
						<a href="javascript:passfound()">비밀번호찾기</a>
					</div>
				...
				<div class="container">
					<form name="company" method="post">
						...
						<table class="middle">
							...
							<tr>
								<td>비밀번호 <input type=password name="com_pass"></td>
							</tr>
							<tr>
								<td><input type=button value="로그인"
									onClick="javascript:send()"></td>
							</tr>
						</table>
					</form>
					<table>
