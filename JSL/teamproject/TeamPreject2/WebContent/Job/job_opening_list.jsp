	...
	<div class=container>
		...
		<div class=main>
			<div class=listmenu>
				...
				<div onclick="location.href='Job_application?cmd=job_application_view_user'">지원한 공고</div>
				</c:if>
			</div>
			<!-- search -->
			<div class=searchjob>
				<div style="display:flex;">
					<form name = search method = post action = "Job_opening?cmd=job_opening_list"><input placeholder='공고제목' type=text name = key></form>
