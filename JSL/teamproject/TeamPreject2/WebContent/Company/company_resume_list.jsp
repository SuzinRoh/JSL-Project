     	...
     	<table class="table table-hover">
            ...
            <c:if test="${empty list }">
 	   		...
 	   		<c:forEach var="user" items="${list }">
							 <tr>
                                <td>${listcount }</td>
                                <td colspan="2"><a class="list" href="Company?cmd=company_resume_view&idx=${user.resume_num }&page=${page}">${user.user_name }</td>
                                <td>${user.resume_regidate.substring(0,10) }</td>
                                <c:if test="${user.resume_private == 'T' }">
                                	<td>공개</td>
                                </c:if>
                                <c:if test="${user.resume_private == 'F' }">
                                	<td>비공개</td>
                                </c:if>
                                <td></td>
                            </tr>
