...
public class UserCoverLetterList implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String pageSkip = "";
		pageSkip = PageIndex.pageList(nowpage, totpage, "User?cmd=user_cover_letter_list", "");
		...
		RequestDispatcher rd = request.getRequestDispatcher("User/user_cover_letter_list.jsp");
