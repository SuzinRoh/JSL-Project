    ...
    <section class="inner-page pt-4">
      <div class="container">
     	<table class="table table-hover">
            ...
            <c:if test="${empty list }">
 	   		...
 	   		<c:forEach var="user" items="${list }">
							 <tr>
                                <td>${listcount }</td>
                                <td colspan="2"><a class="list" href="User?cmd=user_cover_letter_view&idx=${user.cover_num }&page=${page}">${user.cover_subject }</td>
		...
		<c:set var="listcount" value="${listcount-1 }"/>
                        ...
                        <div><input type=button value="자기소개서 작성하기"  onClick="location.href='User?cmd=user_cover_letter_insert'"></div>
