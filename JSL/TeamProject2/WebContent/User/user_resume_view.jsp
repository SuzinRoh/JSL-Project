...
<c:if test="${row eq -2 }">
<script>
	alert("등록된 이력서가 존재하지 않습니다.");
	location.href = "User?cmd=user_resume_insert";
</script>
</c:if>
  ...
  <main id="main">
    ...
    <section class="inner-page pt-4">
      <div class="container">
         ...
         <table class="table table-hover">
          <thead>
           <th>조회수 : ${ur.resume_readcnt }</th>
           	...
           	<tbody>
		  		<tr>
          	<td><b>이　름</b>&emsp;&emsp;${user.user_name }</td>
          		</tr>
          		<tr>
          	<td><b>이메일</b>&emsp;&emsp;${user.user_email }</td>
          		</tr>
          		<tr>
		...
		<a href="User?cmd=user_resume_modify"><input type=button value="수정"></a>
