...
<script>
	function del_(){
		var url = "User?cmd=user_cover_letter_delete&idx="+${ucvl.cover_num}
		window.open(url, "delete", "width=350, height=300");
	}
</script>
</c:if>
  ...
  <main id="main">
    ...
    <section class="inner-page pt-4">
      <div class="container">
        <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <td>작성일 : ${ucvl.cover_regidate.substring(0,10) }
 	  ...
 	  <div><input type=button value="수정"  onClick="location.href='User?cmd=user_cover_letter_modify&idx=${ucvl.cover_num}&page=${page }'">
 	  <input type=button value="삭제"  onClick="del_()">
 	  <input type=button value="뒤로가기"  onClick="history.back()"></div>
