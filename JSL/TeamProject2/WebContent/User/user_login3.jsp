        ...
        <p>
          <form name="login"  method="post" >
          	<table>
          		<tr>
          			<td>
          				아이디 <input type=text name=userid size=16 maxlenght=16 style="WIDTH:155">
          			</td>
          		</tr>
          		<tr>
          			<td>
          				비밀번호 <input type=password name=passwd size=16 maxlenght=16 style="WIDTH:155">
          			</td>
          			<td>
          		...
          		<tr>
          			<td>
          				<a href="javascript:search_id()">아이디 찾기</a>
          				<a href="javascript:search_pass()">비밀번호 찾기</a>
          			</td>
          		</tr>
          	</table>
          </form>
        ...
        <p>
          <form name="login"  method="post" >
          	<table>
          		...
          		<tr>
          			<td>
          				<a href="javascript:search_id()">IDを再設定</a>
          				<a href="javascript:search_pass()">パスワードを再設定</a>
          			</td>
          		</tr>
          	</table>
          </form>
