...
<title>JSL46TH_TEAMPROJECT</title>
...
/* .opening_companyInfo:focus { */
/* 	border: 1px solid #64DFB3; */
/* 	border-radius: 6px; */
/* } */
</style>
</head>
...
<body>
	...
	<div id="topbar"
        ...
        <a href="#" class="facebook"></i></a> -->
				<c:if test="${empty comvo && empty user}">
					<a href="/Main?cmd=login_form" class="linkedin">로그인</a>
					<a href="/Main?cmd=join_form" class="instagram">회원가입</a>
				</c:if>
				<c:if test="${!empty comvo }">
					<a href="/Company?cmd=company_cover_letter_list" class="linkedin">자기소개리스트</a>
					<a href="/Company?cmd=company_resume_list" class="linkedin">이력서리스트</a>
					<a href="/Job_application?cmd=job_application_view_company" class="linkedin">신청확인하기</a>
					<a href="/Company?cmd=company_modify" class="linkedin">정보수정</a>
					<a href="/Company?cmd=company_logout" class="instagram">로그아웃</a>
				</c:if>
				<c:if test="${!empty user }">
					<a href="/User?cmd=user_myinfo" class="facebook">MyPage</a>
					 <a href="/User?cmd=user_write_port" class="instagram">Portfolio작성</a>
	...
	<header id="header" class="fixed-top header-transparent">
		<div
			...
			<h1 class="logo">
				<a href="Main?cmd=main_index">LinkedJSL</a>
			</h1>
			...
			<nav class="main-nav d-none d-lg-block">
				<ul>
					<li class="active"><a href="Main?cmd=main_index">Home</a></li>
		...
		<div class="container d-flex h-100">
			<div class="row justify-content-center align-self-center"
				...
				<div class="col-lg-6 intro-info order-lg-first order-last"
					...
					<h2>안녕하세요</h2>
					<br>for Your<span>Business!</span>
					</h2>
					<div style="padding-bottom: 10px;">
						<button class="btn_join" onclick="location.href='#portfolio'">공고검색</button>
					</div>
					<div style="padding-bottom: 10px;">
						<button class="btn_join" onclick="location.href='Job_opening?cmd=job_opening_insert'">공고등록</button>
					</div>
...
<!-- 					<h3>Services</h3> -->
<!-- 					<p>Laudem latine persequeris id sed, ex fabulas delectus quo. -->
<!-- 						No vel partiendo abhorreant vituperatoribus.</p> -->
<!-- 				</header> -->
...
<!-- 		</section> -->
		...
		<section id="portfolio" class="portfolio section-bg">
			<div class="container" data-aos="fade-up">
				...
				<header class="section-header">
					<h3 class="section-title" onClick="location.href='Job_opening?cmd=job_opening_list'">기업공고</h3>
				</header>
							...
							<div class="col-sm-6">
								...
								<div class="footer-info">
									...
									<p>Cras fermentum odio eu feugiat lide par naso tierra.
										...
										mare fermentum iaculis eu non diam phasellus. Scelerisque
										felis imperdiet proin fermentum leo. Amet volutpat consequat
								...
								<div class="footer-newsletter">
									...
									<p>Tamen quem nulla quae legam multos aute sint culpa legam
										...
										quorum culpa amet magna export quem.</p>
...
<!-- 										<li><a href="#">Services</a></li> -->
					...
					<div class="col-lg-6">
						...
						<div class="form">
							...
							<p>Eos ipsa est voluptates. Nostrum nam libero ipsa vero.
