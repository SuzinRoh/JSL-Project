  ...
  <main id="main">
    ...
    <section class="inner-page pt-4">
      <div class="container">
        <p>
       	 	<form>
       	 		<input type = button onClick="location.href='AdminNeko?cmd=admin_insert';" value = "관리자 추가">
       	 		<input type = button value = "기업 회원가입 승인" onClick = "location.href='AdminNeko?cmd=admin_confirm';">
        	</form>
        </p>
      </div>
    </section>
