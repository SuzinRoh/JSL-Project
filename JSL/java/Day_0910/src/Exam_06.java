...
public class Exam_06 {
	...
	static int data[]= {5,10,20,25,30,35,40,45,50,60,65,70,75,80,85,90};//누구나 다 쓸수있는 배열( staic(꼮써야함) ) exam06에서 공동으로 씀 ==클래스에 속한 배열 ,공유자원
	
	static int search(int searchNum) {//검색메소드
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			int a=search(searchNum);//search메소드 return값 a에저장
