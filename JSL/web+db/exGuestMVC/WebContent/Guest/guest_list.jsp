					...
					<tr>
						<td colspan="7" align="center" valign="center" height="20"><font
							size="4" face="돋움" color="blue"> <img
								src="/Guest/img/bullet-01.gif"> <b>방 명 록</b></font></td>
					</tr>
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : ${totcount }</b>건 - ${page } Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
						...
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="left" height="20"><font face="돋움" size="2"
								color="#000000"><a class="list"
									href="Guest?cmd=guest_view&idx=${guest.idx }&page=${page}">
										${guest.subject }</a></td>
									...
									<table>
										<form name="sfrm" method="post">
											...
											<tr>
												...
												<td><a href="#"><img src="/Guest/img/search2.gif"border="0"></a></td>
											</tr>
										</form>
									</table>
								</td>
								<td width="25%" align="right"><a
									href="Guest?cmd=guest_write&page=${page}"><img
										src="/Guest/img/write.gif" border="0"></a></td>
							</tr>
						</table>
					</div>
</body>
