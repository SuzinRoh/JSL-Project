     ...
     <tr>
      ...
      <font size="2">
       ...
       <a href="Guest?cmd=guest_list&page=${page}"><img src="/Guest/img/list-2.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="Guest?cmd=guest_modify&page=${page}&idx=${guest.idx}"><img src="/Guest/img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="Guest?cmd=guest_delete&page=${page}&idx=${guest.idx}" onclick="window.open(this.href,'삭제','width=100px,height=100px'); return false;" border="0"><img src="/Guest/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
