...
<script>
	function send(){
		alert("hi");
		frm.action="/adminNoticeModify.do";
		frm.submit();
	}
</script>
</head>
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								...
								<td bgcolor="ffffff"><input name="subject" type="text" value="${vo.getSubject() }"  style="width:450; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
							...
							<tr bgcolor="EcECEC">
								...
								<td bgcolor="ffffff"><textarea name="contents" cols="10" rows="10" style="width:490; height:200; padding:2; border:1 solid slategray" tabindex="2">${vo.getContents() }</textarea></td>
							</tr>
						</table>
						</form>
					</td>
