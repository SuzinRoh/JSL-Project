...
<script>
	function sendsearch(){
		b_search.action="/adminNoticeList.do";
		b_search.submit();
				...
				<table width="80%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td><table width="100%" border="0" cellpadding="6"
								...
								<tr>
									<td align="center" bgcolor="#FFFFFF">${notice.idx}</td>
									<td bgcolor="#FFFFFF"><a href="/adminNoticeView.do?idx=${notice.idx}&page=${page}" class="unnamed1">${notice.subject }</a></td>
										...
										<td colspan="10" align="center" bgcolor="#FFFFFF"><table
												...
												<tr>
													...
													<td width=20% align="left"><button oneclick="sendsearch()">검색</button>
														&nbsp;<button><a href="/adminNoticeWrite.do?page=${page}">글쓰기</a></button></td>
												</tr>
											</table>
											</td>
									</tr>
