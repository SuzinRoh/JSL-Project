...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								...
								<td colspan=3 bgcolor="ffffff">${vo.getSubject()}</td>
							</tr>
							<tr>
								<td width="20%" align="center" bgcolor="EcECEC"><strong>등록일</strong></td>
								<td width="40%" bgcolor="ffffff">${vo.getRegdate().substring(0,10)}</td>
								<td width="20%" align="center" bgcolor="EcECEC"><strong>조회수</strong></td>
								<td align="center" bgcolor="ffffff">${vo.getReadcnt()}</td>
							</tr>
							<tr bgcolor="EcECEC">
								<td align="center" bgcolor="EcECEC"><strong>내용</strong></td>
								<td colspan=3 bgcolor="ffffff">${vo.getContents()}</td>
							</tr>
						</table>
					</td>
				</tr>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="/adminNoticeModify.do?idx=${idx}&page=${page}"><b>[수정]</b></a>&nbsp; 
					<a href=""><b>[삭제]</b></a>&nbsp; <a href=""><b>[목록]</b></a></td>
				</tr>
			</table>
</body>
</html>
