...
<c:if test="${totcount == 0}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">no</font></td>
...
<c:if test="${totcount !=0}">
 ...
 <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${listcount }</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="/pdsView.do?idx=${pds.idx}&page=${page}">${pds.subject }</a></font></td>
   ...
   <tr>
      <td colspan="7" align="right">
				<a href="/pdsWrite.do?page=${page}"><img src="Pds/img/write.gif" alt="자료등록" align="middle" border="0"/></a>
      &nbsp;
	  </td>
   </tr>
     ...
     <table border="0" cellspacing="0" width="100%">
      ...
      <font color="#004080" size="4" face="Courier New"><strong>Search&nbsp;</strong></font>
        <select name="search" size="1" style="font-family: 돋움체">
		   ...
		   <option value="name" <c:if test="${name=='name'}">selected</c:if>>작성자</option>
		   <option value="contents" <c:if test="${contents=='contents'}">selected</c:if>>글내용</option>
		</select>
		&nbsp;&nbsp;<input type="text" name="key" size="20">
		&nbsp;&nbsp;<input type="image" src="Pds/img/search2.gif" align="middle" onclick="sendSearch()">
	   </td>
	   </tr>
    </table>
   </table>
