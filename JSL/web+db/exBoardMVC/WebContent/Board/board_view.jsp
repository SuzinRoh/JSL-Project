   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="Board?cmd=board_modify&page=${page}&idx=${idx}">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="Board?cmd=board_delete&page=${page}&idx=${idx}" onclick="window.open(this.href,'삭제','width=100px,height=100px'); return false;"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
