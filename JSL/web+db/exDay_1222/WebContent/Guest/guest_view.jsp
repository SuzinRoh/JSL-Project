...
<%
	...
	String query = "select * from tbl_guest2 where idx="+idx;
     ...
     <tr>
       ...
       <table border="0" width="90%" align="center" cellspacing="0"  style="border-width:1px;border-color:#0066cc;border-style:outset;">
         ...
         if(rs.next()){
     		...
     		String contents = rs.getString("contents").replace("/n","<br>");
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <%=name %>  / <font size="2" face="돋움"><%=regdate %> /최근수정일자/ 1번 읽음</font>
             <p>
             <%=contents %><p>
           </td>
         </tr>
      ...
      <font size="2">
       ...
       <a href="/Guest/guest_modify.jsp?idx="<%=rs.getInt("idx") %>>수정</a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
