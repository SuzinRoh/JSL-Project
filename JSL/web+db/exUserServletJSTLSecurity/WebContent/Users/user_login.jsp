					   ...
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							<tr valign=bottom> 
							  ...
							  <td width="175">: 
								<input type=text name="userid" size=16 maxlength=16 STYLE="WIDTH:155" value="">
							  </td>
							  <td width="79"></td>
							</tr>
							<tr valign=bottom> 
							  ...
							  <td nowrap>비밀번호</td>
							  <td>: 
								<input type=password name="passwd" size=14 maxlength=12 STYLE="WIDTH:155" value="">
							  </td>
							  <td><a href="javascript:send()"><input type=image src="Users/img/login.gif" border=0 align=absmiddle></a></td>
							</tr>
						  </table>
						</td>
					  </tr>
