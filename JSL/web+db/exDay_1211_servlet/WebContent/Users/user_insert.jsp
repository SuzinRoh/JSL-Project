								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  								<a href=""><img src="Users/img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
						...
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							...
							<tr bgcolor=#ffffff>
								<td colspan=3 align=center>
									...
									<img src="Users/img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4 onClick="del()">
								</td>
							</tr>
						</table> 
					</td>
