...
<%
	...
	query ="select * from tbl_guest where idx="+idx;
	pstmt = conn.prepareStatement(query);
	//pstmt.setInt(1,idx);
 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <%=name %>  / <font size="2" face="돋움"><%= rs.getString("regdate").substring(0,10)%> /<%= rs.getInt("readcnt")%>번 읽음</font>
             <p>
            <p>
           </td>
         </tr>
      ...
      <!-- 수정 삭제가 끝나면 리스트로 제목과 내용만 수정가능하게 -->
      </font>
    </td>
  </tr>
  </table>
