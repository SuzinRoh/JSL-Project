...
<%@ page import="exBoard_Servlet_JSP.model.*" %>
<%
	
	BoardVO tmp = (BoardVO) request.getAttribute("vo");
%>
 <html>
 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 새글쓰기 -->
       <a href="BoardWrite.do?page=${page}">
       <img src="Board/img/write.jpg" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href="BoardEdit.do?idx=${idx}&page=${page}">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="BoardDelete.do?idx=${idx}&page=${page}" onclick="window.open(this.href,'삭제','width=100px,height=100px'); return false;"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="BoardList.do?page=${page }"><img src="Board/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
