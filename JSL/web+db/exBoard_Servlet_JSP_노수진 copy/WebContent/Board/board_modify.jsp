...
<script>
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form name="frm" method="post" action="BoardEdit.do">
      ...
      <table border="0">
       ...
       <tr>
        ...
        <tr>
          ...
          <td>
	          <button onclick="edit_frm()"><img src="Board/img/edit2.gif" border=0></button>&nbsp;
	          <a href="history.back()"><img src="Board/img/cancle.gif" border=0></a>
          </td>
          </tr>
      </table>
      </form>
