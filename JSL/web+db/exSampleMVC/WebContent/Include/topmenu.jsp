 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr>
     <td width="20%" rowspan="4" valign="bottom" bgcolor="#000000">
       <a href="Main?cmd=index"><img src="Include/img/ceo.jpg" width="158" height="83" border="0"></a>
     ...
     <c:if test="${!empty Session_User }">
      <p align="center"><font color="white" size="2"><b>${Session_User.userid }님</b></font></p>
     <p align="center"><font color="white" size="2"><b><a href="User?cmd=user_logout&username=${Session_User.userid}"  class="white">로그아웃</A></b></font></p>
     </c:if>
     </td>
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="Notice?cmd=notice_list">공지사항</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="Board?cmd=board_list" class="white">게시판<a></a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="Admin?cmd=admin_index">관리자</a></b></font></p>
     </td>
   </tr>                   
   <tr>
     <td colspan="8">
