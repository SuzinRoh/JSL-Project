...
<script>
	function send(){
		alert("ok");
		frm.action="Board?cmd=board_write_pro";
		frm.submit();
	}
</script>
</head>
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
	 ...
	 <input type="hidden" method="post" name="page" value="${page}">
	  <table border="0">
       <tr>
	   ...
	   <tr>
         ...
         <td><font size="2" face="돋움">비밀번호</font></td>
          <td><input type="password" size="10" name="pass" ><font size="2" face="돋움" value="">*.수정과 삭제시 꼭 입력하셔야 합니다.</font></td>
        </tr>
        <tr></tr>
		<tr>
          <td align="right">&nbsp;</td>
