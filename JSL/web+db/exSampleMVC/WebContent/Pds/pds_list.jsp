...
<!--  다음에 추가할 부분 -->
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">not exist write</font></td>
      ...
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${listcount }</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="Pds?cmd=pds_view&page=${page }&idx=${pds.idx}">${pds.subject }</a></font></td>
	...
	<form name=sfrm method=post>
     <table border="0" cellspacing="0" width="100%">
      ...
      <font color="#004080" size="4" face="Courier New"><strong>Search&nbsp;</strong></font>
		...
		&nbsp;&nbsp;<input type="image" src="Pds/img/search2.gif" align="middle" onclick="s_send()">
	   </td>
	   </tr>
    </table>
    </form>
