...
<script>
	function send(){
		frm.action="Pds?cmd=pds_modify_pro";
		frm.submit();
	}
...
<input type="hidden" name="page" value="${page}">
    ...
    <tr>
      ...
      <td width="80%"><input type="text" size="20" name="name" value="${pds.name }"></td></tr>
    <tr>
      <td align="right">&nbsp;</td>
    ...
    <tr>
      ...
      <td><input name="oldfilename" size="30" value="${pds.filename }" readonly></td></tr>
    <tr>
     <tr>
      <td align="right"><img src="Pds/img/bullet-02.gif"></td>
      <td><font size="2" face="돋움">파일첨부</font></td>
      <td><input type="file" name="filename" size="30" value=""></td></tr>
    <tr>
      <td align="right"><img src="Pds/img/bullet-02.gif"></td>
      <td><font size="2" face="돋움">비밀번호</font></td>
      <td><input type="password" size="10" name="pass" value=""></td></tr>
    <tr>
      <td align="right">&nbsp;</td>
