...
<script>
	function send(){
		alert("hi");
		frm.action="Admin?cmd=admin_notice_modify_pro";
		frm.submit();
	}
</script>
</head>
		...
		<td align="center" height="100%" valign=middle><br>
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								...
								<td bgcolor="ffffff"><input name="subject" type="text" value="${notice.getSubject()}"  style="width:450; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
							...
							<tr bgcolor="EcECEC">
								...
								<td bgcolor="ffffff"><textarea name="contents" cols="10" rows="10" style="width:490; height:200; padding:2; border:1 solid slategray" tabindex="2">${notice.getContents() }</textarea></td>
							</tr>
						</table>
						</form>
					</td>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align=center><a href="javascript:send()"><b>[수정]</b></a>&nbsp;
					 <a href="javascript:history.back()"><b>[취소]</b></a></td>
				</tr>
			</table>
</body>
</html>
