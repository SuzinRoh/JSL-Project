...
<script>
	function send(){
		alert("hi");
		frm.action="Admin?cmd=admin_index_pro";
		frm.submit();
	}
</script>
</head>
                      ...
                      <td width="308" align="center" background="Admin/img/admin_img07.gif"> 
                        ...
                        <table width="275" height="63" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <!--버튼 --><td width="61" rowspan="3"><input type='image' src="Admin/img/admin_img12.gif" alt="connect" value="submit" width="61" height="63" border="0" onfocus=blur() onclick="send()"></a></td>
                          </tr>
                          <tr> 
