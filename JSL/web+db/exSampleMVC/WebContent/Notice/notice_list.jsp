...
<script>
	function send(){
		sfrm.action="Notice?cmd=notice_list";
		sfrm.submit();
	}
</script>
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : ${totcount}개</b>&nbsp;&nbsp; ${totpage}건 - ${page}Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
	...
	<c:forEach var="notice" items="${list }">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="Notice?cmd=notice_view&idx=${notice.idx }&page=${page}">${notice.subject }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" >${notice.name}</font></td>
	 ...
	 <c:set var="listcount" value="${listcount-1 }"/>
      ...
      <c:if test="${empty list }">
        ...
        <font face="돋움" size="2" color="#000000">nothing</font></td>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:send()"><img src="Notice/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
