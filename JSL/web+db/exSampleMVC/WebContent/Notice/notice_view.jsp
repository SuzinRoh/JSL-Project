   ...
   <table border="0" width="800">
     <tr>
       ...
       <table border="0" width="90%" align="center" cellspacing="0"  style="border-width:1px;border-color:#0066cc;border-style:outset;">
         ...
         <tr>
           <td class="content">
             ...
             ${notice.name } / <font size="2" face="돋움">${notice.regdate.substring(0,10) } / ${notice.readcnt }번 읽음</font>
             <p>
      ...
      <p align="center">
       ...
       <a href="Notice?cmd=notice_list&page=${page }"><img src="Notice/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
