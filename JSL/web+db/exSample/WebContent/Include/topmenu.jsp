 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr>
    ...
    <c:if test="${empty loginuser}">
     ...
     <c:if test="${empty loginuser}">
     <p align="center"><font color="white" size="2"><b><a href="/UserInsert.do" class="white">회원가입</a></b></font></p>
     </c:if>
     <c:if test="${!empty loginuser}">
     <p align="center"><font color="white" size="2"><b><a href="/UserModify.do" class="white">정보수정</a></b></font></p>
     </c:if>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/BoardList.do" class="white">게시판</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
