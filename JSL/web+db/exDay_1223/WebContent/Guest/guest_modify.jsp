 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <img src="./img/bullet-02.gif"><font size="2" face="돋움">는 필수 입력 사항입니다.</font><p>
		 ...
		 <form method="post" action="guest_modify_pro.jsp" name="frm">
      ...
      <table border="0">
       <tr>
         ...
         <td width="80%"><input type="text" size="20" name="name" value="<%=vo.getName() %>" readonly></td>
       </tr>
       <tr>
         <td width="5%" align="right"><img src="./img/bullet-02.gif"></td>
         <td width="15%"><font size="2 face="돋움">비밀번호</font></td>
         <td width="80%"><input type="password" size="20" name="pass" value="" ></td>
       </tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
         <td><font size="2" face="돋움">제목</font></td>
         <td><input type="text" size="60" name="subject" value="<%=vo.getSubject() %>"><tr>
       </tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
